...
static int ext_misc_cat[] = {
    ...
    CMD_VARMNU1, CMD_ACCEL,   CMD_LOCAT, CMD_HEADING, CMD_FPTEST, CMD_NULL
};
#define MISC_CAT_ROWS 2
#else
static int ext_misc_cat[] = {
    CMD_FMA,     CMD_GETKEY1, CMD_NOP,   CMD_PGMMENU, CMD_PRMVAR, CMD_STRACE,
    CMD_VARMNU1, CMD_ACCEL,   CMD_LOCAT, CMD_HEADING, CMD_NULL,   CMD_NULL
};
#define MISC_CAT_ROWS 2
#endif
#else
...
static int ext_misc_cat[] = {
    CMD_FMA,     CMD_GETKEY1, CMD_NOP,  CMD_PGMMENU, CMD_PRMVAR, CMD_STRACE,
    CMD_VARMNU1, CMD_FPTEST,  CMD_NULL, CMD_NULL,    CMD_NULL,   CMD_NULL
};
#define MISC_CAT_ROWS 2
#else
static int ext_misc_cat[] = {
    CMD_FMA,     CMD_GETKEY1, CMD_NOP,  CMD_PGMMENU, CMD_PRMVAR, CMD_STRACE,
    CMD_VARMNU1, CMD_NULL,    CMD_NULL, CMD_NULL,    CMD_NULL,   CMD_NULL
};
#define MISC_CAT_ROWS 2
#endif
#endif

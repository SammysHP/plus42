...
const command_spec cmd_array[] =
{
    ...
    { /* SIGMAADD */   docmd_sigmaadd,    "\005+",               0x00, 0x00, 0x00, 0x47,  2, ARG_NONE,   2, 0x05 }, // seq?
    { /* SIGMASUB */   docmd_sigmasub,    "\005-",               0x00, 0x00, 0x00, 0x48,  2, ARG_NONE,   2, 0x05 }, // seq?
    ...
    { /* DIM_T */      docmd_dim_t,       "DIM?",                0x00, 0x00, 0xa6, 0xe7,  4, ARG_NONE,   1, 0x0a },
    ...
    { /* CROSS */      docmd_cross,       "CROSS",               0x00, 0x00, 0xa6, 0xca,  5, ARG_NONE,   2, 0x06 },
    ...
    { /* DIM */        docmd_dim,         "DIM",                 0x00, 0xc4, 0xf2, 0xec,  3, ARG_MAT,    2, 0x01 }, // seq?
    { /* DOT */        docmd_dot,         "DOT",                 0x00, 0x00, 0xa6, 0xcb,  3, ARG_NONE,   2, 0x0e },
    { /* EDIT */       docmd_edit,        "EDIT",                0x00, 0x00, 0xa6, 0xe1,  4, ARG_NONE,   1, 0x0c }, // seq?
    ...
    { /* PUTM */       docmd_putm,        "PUTM",                0x00, 0x00, 0xa6, 0xe9,  4, ARG_NONE,   1, 0x0c }, // seq?
    ...
    { /* UVEC */       docmd_uvec,        "UVEC",                0x00, 0x00, 0xa6, 0xcd,  4, ARG_NONE,   1, 0x0e },
    ...
    { /* CONCAT */     docmd_concat,      "CONCAT",              0x00, 0x00, 0xa7, 0xe9,  6, ARG_NONE,   2, ALLT },
    { /* SUBSTR */     docmd_substr,      "SUBSTR",              0x00, 0x00, 0xa7, 0xea,  6, ARG_NONE,   2, FUNC },
    { /* LENGTH */     docmd_length,      "LENGTH",              0x00, 0x00, 0xa7, 0xeb,  6, ARG_NONE,   1, 0x30 },
    { /* HEAD */       docmd_head,        "HEAD",                0x00, 0x03, 0xf2, 0x13,  4, ARG_VAR,    0, NA_T },
    { /* REV */        docmd_rev,         "REV",                 0x00, 0x00, 0xa7, 0xec,  3, ARG_NONE,   1, 0x30 },
    { /* POS */        docmd_pos,         "POS",                 0x00, 0x00, 0xa7, 0xed,  3, ARG_NONE,   2, FUNC },
    { /* S_TO_N */     docmd_s_to_n,      "S\017N",              0x00, 0x00, 0xa7, 0xee,  3, ARG_NONE,   1, 0x10 },
    { /* N_TO_S */     docmd_n_to_s,      "N\017S",              0x00, 0x00, 0xa7, 0xef,  3, ARG_NONE,   1, 0x01 },
    { /* C_TO_N */     docmd_c_to_n,      "C\017N",              0x00, 0x00, 0xa7, 0xf0,  3, ARG_NONE,   1, 0x10 },
    { /* N_TO_C */     docmd_n_to_c,      "N\017C",              0x00, 0x00, 0xa7, 0xf1,  3, ARG_NONE,   1, 0x01 },
    { /* LIST_T */     docmd_list_t,      "LIST?",               0x00, 0x00, 0xa7, 0xf2,  5, ARG_NONE,   1, ALLT },
    { /* NEWLIST */    docmd_newlist,     "NEWLIST",             0x00, 0x00, 0xa7, 0xf3,  7, ARG_NONE,   0, NA_T },
    { /* NEWSTR */     docmd_newstr,      "NEWSTR",              0x00, 0x00, 0xa7, 0xf4,  6, ARG_NONE,   0, NA_T }
};
